...
Revision ID: 36edc0e56aa8
Revises: None
Create Date: 2014-03-27 00:01:53.514714

"""

# revision identifiers, used by Alembic.
revision = '36edc0e56aa8'
down_revision = None
...
def upgrade():
    ...
    op.create_table('mentor_to_mentee',
    sa.Column('mentors', sa.Integer(), nullable=False),
    sa.Column('mentees', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['mentees'], ['users.id'], ),
    sa.ForeignKeyConstraint(['mentors'], ['users.id'], ),
    sa.PrimaryKeyConstraint('mentors', 'mentees')
    )
...
def downgrade():
    ...
    op.drop_table('mentor_to_mentee')
