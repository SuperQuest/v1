...
class MentorRegistrationForm(RegistrationForm):
    interests = StringField('interests', validators=[Required()])
    linkedin_id = StringField('LinkedIn', validators=[Required()])
    about_me = TextAreaField('Please share your experience and expertise')
    submit = SubmitField('Register')
...
class ParentRegistrationForm(RegistrationForm):
    participate = BooleanField('Would you like mentor other students?', validators=[Required()])
    submit = SubmitField('Register')
